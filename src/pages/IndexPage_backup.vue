            ...
            <q-tab-panel v-for="info in multiTotalInfos" :key="info.pool" :name="info.pool">
              ...
              <q-markup-table style="background-color: rgba(255,255,255, 0.6)">
                ...
                <tr v-for="data in info.totalInfos" :key="data.id">
                  <q-tooltip>{{ data.statistics.text }}</q-tooltip>
  ...
  methods: {
    ...
    async showAll() {
      ...
      for (const pool of this.pools) {
        ...
        totalInfos.push({
          probability: rateInfo.probability.star6, repetition: rateInfo.repetitionRate.star6,
          count: rateInfo.count.star6, countNoRepetition: rateInfo.countNoRepetition.star6, type: '6星', id: 0, statistics: this.statistics(probability.star6)
        });
        totalInfos.push({
          probability: rateInfo.probability.star5, repetition: rateInfo.repetitionRate.star5,
          count: rateInfo.count.star5, countNoRepetition: rateInfo.countNoRepetition.star5, type: '5星', id: 1, statistics: this.statistics(probability.star5)
        });
        totalInfos.push({
          probability: rateInfo.probability.star4, repetition: rateInfo.repetitionRate.star4,
          count: rateInfo.count.star4, countNoRepetition: rateInfo.countNoRepetition.star4, type: '4星', id: 2, statistics: this.statistics(probability.star4)
        });
        totalInfos.push({
          probability: rateInfo.probability.star3, repetition: rateInfo.repetitionRate.star3,
          count: rateInfo.count.star3, countNoRepetition: rateInfo.countNoRepetition.star3, type: '3星', id: 3, statistics: this.statistics(probability.star3)
        });
